...
call reportgenerator "-title:Yachtsystem Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:Yachtsystem Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for Yachtsystem
call OpenCppCoverage.exe --export_type=binary:yachtsystem_tests_unit_win.cov --sources src\yachtsystem\src --sources src\yachtsystem\header --sources src\tests\yachtsystem -- build_win\build\Debug\yachtsystem_tests.exe

echo Generate Test Coverage Data for Yachtsystem App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=yachtsystem_tests_unit_win.cov --export_type=cobertura:yachtsystemapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\yachtsystem\src --sources src\yachtsystem\header --sources src\yachtsystemapp\src --sources src\yachtsystemapp\header --sources src\tests\utility --sources src\tests\yachtsystem -- build_win\build\Debug\yachtsystemapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:Yachtsystem Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/yachtsystemapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/yachtsystem/src;src/yachtsystem/header;src/yachtsystemapp/src;src/yachtsystemapp/header;src/tests/utility;src/tests/yachtsystem" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/yachtsystemapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/yachtsystem/src;src/yachtsystem/header;src/yachtsystemapp/src;src/yachtsystemapp/header;src/tests/utility;src/tests/yachtsystem" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\yachtsystem\header "build_win\build\Release" /E
call robocopy src\yachtsystemapp\header "build_win\build\Release" /E
...
call robocopy src\yachtsystem\header "build_win\build\Debug" /E
call robocopy src\yachtsystemapp\header "build_win\build\Debug" /E
